...
public static class KeycodeManager
{
    ...
    public static CustomKeyCode backward = CustomKeyCode.S;
    public static CustomKeyCode right = CustomKeyCode.D;
    public static CustomKeyCode left = CustomKeyCode.Q;
    public static CustomKeyCode jump = CustomKeyCode.Space;
    public static CustomKeyCode run = CustomKeyCode.A;
    public static CustomKeyCode crouch = CustomKeyCode.X;
    public static CustomKeyCode precisionGrapple = CustomKeyCode.Mouse0;
    public static CustomKeyCode swingingGrapple = CustomKeyCode.Mouse1;
    public static CustomKeyCode extendGrapplingCable = CustomKeyCode.S;
    public static CustomKeyCode shortenGrapplingCable = CustomKeyCode.Space;
    public static CustomKeyCode wallrunUpwards = CustomKeyCode.A;
    public static CustomKeyCode wallrunDownwards = CustomKeyCode.X;
    public static CustomKeyCode mantle = CustomKeyCode.Space;
    public static CustomKeyCode slide = CustomKeyCode.C;
    public static CustomKeyCode pauseMenu = CustomKeyCode.Escape;
    public static CustomKeyCode toggleFullscreen = CustomKeyCode.F11;
